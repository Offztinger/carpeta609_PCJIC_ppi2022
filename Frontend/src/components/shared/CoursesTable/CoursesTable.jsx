    ...
    return (
        <div className='contenedorCursos'>
            <Modal
                ...
                onEntered={() => document.querySelector('.modal-content').classList.add('active')}
                onExit={() => document.querySelector('.modal-content').classList.remove('active')}
            >
            ...
            >
                <Modal.Header closeButton>
                    <Modal.Title>
                        {selectedId ? 'Editar' : 'Crear'} {moduleName === 'student' ? 'estudiante' : 'profesor'}
                    </Modal.Title>
                </Modal.Header>
                <Modal.Body>
