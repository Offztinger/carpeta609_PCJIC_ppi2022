		...
		estudiantes.forEach(estudiante => {
			row = [
				...
				[
					...
					{
						v: estudiante.telefono_fijo,
						t: 's',
						s: {},
					},
					{
						v: estudiante.celular,
						t: 's',
						s: {},
					},
					{
						v: estudiante.correo_estudiantil,
						t: 's',
						s: {},
					},
					{
						v: estudiante.correo_personal,
						t: 's',
						s: {},
					},
					{
						v: estudiante.codigo_plan,
						t: 's',
						s: {},
					},
					{
						v: estudiante.modulo_sol,
						t: 's',
						s: {},
					},
				],
			...
			<div className='d-flex w-100 flex-column align-items-center'>
				...
				<div className=''>
					<a data-tooltip-id='my-tooltip' data-tooltip-content='Hello world!'>
						...
						>
							<img src={download} alt='' style={{ height: '45px' }} />
						</button>
					</a>
				</div>
			</div>
